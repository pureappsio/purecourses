...
Router.route('/', {
    name: 'home',
    waitOn: function() {
        return [Meteor.subscribe('userCourses'), Meteor.subscribe('userMetas'), Meteor.subscribe('allFiles')];
    },
    data: function() {
...
Router.route('/login', {
    ...
    //     if (this.params.query.email && this.params.query.password) {

    //         Meteor.loginWithPassword(this.params.query.email, this.params.query.password, function() {
